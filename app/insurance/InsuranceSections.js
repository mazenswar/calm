				...
				<div className="content">
					...
					<div className="ofn-banner">
						...
						<p>
							...
							may not find a therapist who specializes in your concerns.
							Choosing an out-of-network provider allows you to prioritize fit,
					...
					<div className="sub-container">
						...
						<div className="sub">
							...
							<p>
								...
								provider, we have the flexibility to tailor therapy to what
								works best for you, rather than following insurance-mandated
								guidelines.
							</p>
						</div>
						<div className="sub">
							...
							<p>
								...
								some plans reimburse a substantial portion of session fees once
								a deductible is met. If you have a high-deductible plan, you may
								be paying out-of-pocket for therapy either way, so it{"'"}s
								worth choosing a therapist who truly fits your needs and can
			...
			<section className="insurance-section alt">
				<div className="content">
					...
					<p className="linebreak">
						...
						After each session, we will provide a superbill, which you can
						submit to your insurance company. Some clients also use{" "}
					...
					<div className="steps">
						<div className="step-container">
							...
							<p>
								Contact your insurance provider and provide them with our
								business information to confirm if they offer out-of-network
						...
						<div className="step-container">
							...
							<p>
								After receiving the superbill from us, submit it to your
								insurance company along with any required forms to get
								reimbursed for your therapy sessions.
							</p>
						</div>
					</div>
				</div>
			...
			<section className="insurance-section cta">
				<div className="content">
					...
					<h3 className="purple help center-title">
						...
						free to <Link href={"/contact"}>reach out</Link>. We are happy to

...
import ketaBrain from "./assets/images/keta.png";
		...
		<main id="keta">
			<section className="keta-header">
				...
				<div className="text">
					...
					<p>
						Ketamine-Assisted Psychotherapy offers a unique opportunity to reach
						parts of the self that may feel inaccessible through talk therapy or
						traditional treatments. When used in a safe and intentional setting,
						ketamine can loosen rigid thought patterns, soften internal
						defenses, and create space for deeper self-understanding.
					</p>
					<p>
			...
			<section className="keta-box">
				...
				<p>
					...
					that, when used in sub-anesthetic doses and paired with psychotherapy,
					ketamine may provide relief for symptoms of depression, anxiety, OCD,
					PTSD, and other mental health concerns that have not responded to
					traditional treatments.
				</p>
				<p>
					Ketamine is thought to work by increasing neuroplasticity, disrupting
					the default mode network in the brain, and facilitating access to
					previously unconscious thoughts, emotions, and patterns. These shifts
					can support a more open, flexible state of mind, where healing
					insights and emotional breakthroughs are more likely to occur.
				</p>
			</section>
			<section className="keta-box">
				...
				<p>
					...
					comes from how you integrate what arises. KAP is not for everyone, and
					we will assess together whether this is the right path for you.
				</p>
			</section>
			<section className="keta-box">
				...
				<p>
					I partner with{" "}
					<Link legacyBehavior href="https://www.journeyclinical.com/patients">
				...
				<ol>
					...
					<ul>
						<li>
							Initial Consultation: Conducted by Journey Clinical to assess your
							medical and psychiatric history.
						</li>
						<li>
							Prescription: If deemed appropriate, sublingual ketamine lozenges
							are prescribed and shipped to your home pharmacy.
						</li>
					</ul>
					...
					<ul>
						...
						<li>
							Develop grounding and coping tools so you feel safe and supported
							during dosing
						</li>
						<li>
					...
					<ul>
						<li>Format: Currently, I offer KAP exclusively via telehealth.</li>
						<li>
						...
						<li>
							...
							presence via a secure video call. You{"'"}ll be at your home in a
							comfortable, reclining position, possibly with an eye mask and
							calming music.
						</li>
						<li>
					...
					<p>
						...
						to check in as needed but are not actively involved in the session.
					</p>
					<li>Integration Sessions</li>
					<p>
						The integration is one of the most important part of your journeys.
						These sessions are about making sense of your experience. After each
						dosing session, we meet for one or more integration sessions to:
					</p>
					<ul>
						<li>
					...
					<p>
						...
						quarter) to monitor outcomes and prescribe ketamine lozenge refills
						as appropriate.
					</p>
				</ol>
			</section>
			...
			<section className="keta-box">
				...
				<ul>
					<li>
						...
						telehealth. While some clinicians provide in-person KAP, my practice
						is fully remote.
					</li>
					<li>
						Chaperone Requirement: For remote sessions, a trusted support person
						must be present in your home to ensure safety.
					</li>
					<li>
						Medical Oversight: All medical aspects of KAP are managed by Journey
						Clinical.
					</li>
					<li>
						Ethical Practice: I adhere to all professional guidelines to ensure
			...
			<section className="keta-box useful-links">
				...
				>
					<a className="link" target="_blank" rel="noopener noreferrer">
						...
						Ketamine with Psychotherapy- research study by Jennifer Dore et al,
						2018
					</a>
				</Link>
				<Link

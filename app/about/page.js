				...
				<div className="section-block">
					...
					<div className="text">
						...
						<p>
							...
							Hinduism. I don{"'"}t promise spiritual experiences. But I do know
							the power of turning toward your inner world with honesty,
				...
				<div className="section-block alt">
					...
					<div className="text">
						...
						<p>
							...
							institutions including Rutgers University Behavioral Health Care,
							Harvard University/Massachusetts General Hospital, Columbia
							University, Bellevue Hospital Center, and Montclair State
							University. I also have a background in psychological research,
							which continues to inform my work. In addition, I am a certified
							Reiki Master Teacher, and I draw from both scientific and
							energetic perspectives to support each client
				...
				<div className="section-block">
					...
					<div className="text">
						...
						<p>
							...
							context, ketamine can help loosen entrenched thought patterns and
							create openings for deep emotional healing. My approach to KAP
							emphasizes psychological safety, therapeutic depth, and long-term
				...
				<div className="section-block checklist">
					...
					<div className="text">
						...
						<ul>
							...
							<li>
								You{"'"}ve had glimpses of insight or awareness that you want to
								explore more deeply
							</li>
							<li>
								You want a therapist who can hold complexity, challenge gently,
								and walk with you
							</li>
						</ul>
					</div>
				...
				<div className="section-block alt cta">
					...
					<div className="text">
						<h2 className="linebreak">
							...
							. Let{"'"}s explore whether we{"'"}re a good fit, and how therapy
							can support your growth, healing, and clarity, wherever you are in
							your journey.
						</h2>
						<h2>

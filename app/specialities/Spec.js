					...
					<div className="text-container">
						...
						<div className="specc" id="gad">
							...
							<p>
								...
								sense of grounded presence. My approach draws from
						...
						<div className="specc" id="pd">
							...
							<p>
								...
								capacity to stay present with what arises, using techniques that
								support acceptance and nervous system regulation. This approach
								helps reduce reactivity and fosters long-term resilience.
							</p>
						</div>
						...
						<div className="specc" id="ocd">
							...
							<p>
								...
								CBT (i-CBT), and acceptance and commitment therapy (ACT) to help
								clients challenge intrusive thoughts without getting trapped in
								doubt and reassurance-seeking cycles. I approach OCD not just as
					...
					<div className="text-container">
						...
						<div className="specc" id="depression">
							...
							<p>
								...
								joy, and from meaning. My approach supports emotional
						...
						<div className="specc" id="perfectionism">
							...
							<p>
								...
								safety or worth depend on performance, achievement, or control.
								We{"'"}ll begin to practice enoughness from the inside out
							</p>
						</div>
					...
					<div className="text-container">
						...
						<div className="specc" id="lt">
							...
							<p>
								...
								circumstances, or an internal shift, I help clients move through
								it with clarity and integrity. Together, we make space for
								grief, uncertainty, and what may be emerging.
							</p>
						</div>
						...
						<div className="specc" id="sm">
							...
							<p>
								...
								asking new questions about what you{"'"}re doing and why. I work
								with clients to identify both internal and external sources of
								stress and create space for recalibration.
							</p>
						</div>
					</div>
				</div>
					...
					<div className="text-container">
						...
						<div className="specc" id="spi">
							...
							<p>
								...
								to explore those longings without judgment. I do not impose any
								framework, but I hold space for inquiry, awe, and the mystery of
								being human.
							</p>
						</div>
					</div>

...
export const specialities = [
	...
	},
	{
		...
		summary:
			"Many people can struggle with having a negative body image where they feel dissatisfied with their general appearance. However, those with Body Dysmorphic Disorder (BDD) suffer from extreme distress due to the perceived flaw(s) in their physical appearance. They spend a significant amount of time intensely preoccupied by these flaws, which are often not noticeable by others. Consequently, they also spend large amount of time self-criticizing and engaging in checking and reassurance seeking behaviors such as repeatedly checking the mirror, comparing   themselves to others, measuring their body parts, asking others about their appearance etc.\n\nBDD is a very difficult condition to live with and is often associated with high levels of depression, social anxiety and shame. It can affect all aspects of the person’s life including their finances, social and romantic relationships, work and study, and overall life satisfaction.\n\nCognitive Behavioral Therapy is an effective treatment for BDD. While the individual aspects of the treatment are always tailored to meet your unique needs, overall, the treatment for BDD consists of identifying and understanding the thoughts that lead to your negative body image and finding more flexible ways of thinking. Simultaneously, we will work on reducing your reassurance seeking behaviors, which help in the moment but largely keep your BDD going. You will also learn different coping strategies to manage difficult thoughts and urges. We will also identify and work towards goals that enrich your life and matter the most to you but that you may have avoided due to BDD.",
	},
	{
		title: "Depression",
		summary:
	...
	},
	{
		...
		summary:
			"Life has a way of throwing us some curveballs every now and then, which can be difficult to accept and adapt to. While the specific challenge may be different for each individual, therapy can help you adjust to the changes by giving you tools to deal with the worry and uncertainty that come with major life stressors. Additionally, in therapy you can learn how to show up as your best self regardless of the challenges you are facing and develop important insights about the experiences. Broadly, some such challenges may include adjusting to a new job, school or a new country, family issues such as divorce, parenting, blended families, remarriage, coping with grief and loss, unemployment and other major life changes.",
	},
	{
	...
	},
	{
		...
		summary:
			"Struggling with a low self-esteem/self-worth can be detrimental to our mental health and prevent us from living life the way we want. Cognitive Behavior Therapy can help you understand your harmful thought patterns and learn different ways to engage with these thoughts. In therapy, we will also work on improving your self-talk, and move towards goals that can help you be the best version of yourself.",
	},
	{
		title: "Stress Management / Work-Life Balance",
		summary:
			"Stress is a part of life. No matter what we do, it is almost impossible to completely remove stress from our lives. Therefore, learning different ways to manage our stress is essential to creating more well-being for ourselves. If you struggle with managing stress or balancing the demands of your professional and personal lives, therapy can help you build awareness around it, so you know how to intentionally respond to stressors rather than react to them and learn newer ways to cope.",
	},
];

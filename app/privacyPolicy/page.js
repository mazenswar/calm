	...
	return (
		<main id="privacy-policy">
			<section>
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to Center For Anxiety and Life
							Management PLLC, 502 W 7th St ste 100, Erie, PA 16502, USA.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Center for Anxiety and Life
							Management (Calm Therapy), accessible from{" "}
							<a
								href="calmtherapy.center"
				...
				<ul>
					<li>By email: tsingh@calmtherapy.center</li>
				</ul>
			</section>
		</main>
	);
